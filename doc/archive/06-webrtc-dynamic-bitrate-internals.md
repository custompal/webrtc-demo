> **Archived 2026-09-17** — superseded by `doc/design/`; archived verbatim as `doc/archive/06-webrtc-dynamic-bitrate-internals.md`. This copy is history, not current guidance.

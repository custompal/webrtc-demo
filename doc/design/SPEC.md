...
> Status: **frozen** v1.7.2 (owner: `architect`). Task id: t8 (attempt 1), 2026-09-17.
...
* **Pairing list (exhaustive).** Root `README.md` ↔ root `README.en.md`; `doc/design/README.md` ↔ the
  `README.en.md` beside it; `doc/design/zh-CN/NN-<name>.md` ↔ `doc/design/NN-<name>.md` for NN = 01–11.
...
* **V15 — translation disclaimer.** The disclaimer list is the Chinese body pages `doc/design/zh-CN/NN-<name>.md`
  for NN = 01–11 plus the `SPEC-guide.md` beside `doc/design/zh-CN/GLOSSARY.md`; each carries the verbatim line
...
| 1.7.2 | 2026-09-21 | **Enumeration extension (task t6).** §7.6's bilingual **pairing list** and the **V15 disclaimer range** now read NN = 01–11 instead of 01–05, so the six newly translated chapters (`06`–`11`) fall under the switcher duty (R13/V14) and the disclaimer duty (R14/V15). The definition sites stay in `doc/design/zh-CN/GLOSSARY.md` §3.4 (pairing) and §4 Y-1 (disclaimer list); the checker (V14/V15) and the supplementary audit (Z1/Z2) are extended in the same round. **No rule changes meaning** — only the enumeration of covered chapters, the version token and this changelog row. |
